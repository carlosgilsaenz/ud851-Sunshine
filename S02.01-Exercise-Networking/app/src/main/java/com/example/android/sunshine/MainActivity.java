...
public class MainActivity extends AppCompatActivity {
    ...
    private class asyncTask extends AsyncTask<URL,Void,String[]>{
        @Override
        protected String[] doInBackground(URL... param) {
            try {
                String response = NetworkUtils.getResponseFromHttpUrl(param[0]);
                String[] formatedResponse = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this,response);
