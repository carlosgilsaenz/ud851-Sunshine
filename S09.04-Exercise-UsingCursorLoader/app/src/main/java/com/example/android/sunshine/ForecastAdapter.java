...
//      TODO (8) Display the summary that you created above
        if(mCursor.moveToPosition(position)){
            ...
            String dateString = SunshineDateUtils.getFriendlyDateString(mContext,mCursor.getLong(mCursor.getColumnIndex(WeatherContract.WeatherEntry.COLUMN_DATE)),false);;
            int description = mCursor.getInt(mCursor.getColumnIndex(WeatherContract.WeatherEntry.COLUMN_WEATHER_ID));
